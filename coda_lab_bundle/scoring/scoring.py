...
score_dir = '/app/output/'    # For the predictions
submission_dir = '/app/input/res/' # The code submitted
program_dir = './' # Scoring script directory

# score_dir = ''    # For the predictions
# submission_dir = './solution/' # The code submitted
# program_dir = './scoring/' # Scoring script directory
...
try:
    ...
    binary_data = BinaryAdditionDataset(size=SIZE, d_vocab=6, d_vocab_out=3, n_ctx=24, seq_len=12, seed=SEED)
